...
const Register = () => {
    ...
    useEffect(() => {
        const fetchActivityChoices = async () => {
            try {
                const response = await axios.get('https://stockpredictionbackendapp.srv506012.hstgr.cloud/api/v1/activity-choices/');
    ...
    const handleRegistration = async (e) => {
        ...
        try {
            const response = await axios.post('https://stockpredictionbackendapp.srv506012.hstgr.cloud/api/v1/register/', userData);
